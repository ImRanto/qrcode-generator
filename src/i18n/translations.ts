...
export const translations = {
  en: {
    ...
    wifiPasswordReenter: 'Please re-enter the password (omitted from history for security)',
    ...
    templatesTitle: 'Presets / Templates',
    ...
    gradientLabel: 'Color Gradient',
    gradientTypeNone: 'Solid Color',
    gradientTypeLinear: 'Linear Gradient',
    gradientTypeRadial: 'Radial Gradient',
    gradientColorLabel: 'Secondary Gradient Color',
    moduleStyleLabel: 'Module Style',
    styleSquare: 'Square',
    styleRounded: 'Rounded',
    styleDots: 'Dots / Circles',
    eyeStyleLabel: 'Eye / Marker Style',
    eyeColorLabel: 'Eye Color',
    customEyeColorLabel: 'Custom Eye Color',
    ecLevelLabel: 'Error Correction Level',
    ecL: 'Low (7%)',
    ecM: 'Medium (15%)',
    ecQ: 'Quartile (25%)',
    ecH: 'High (30%)',
    ...
    logoFileTooLarge: 'Logo file exceeds 2 MB. Please choose a smaller image.',
  ...
  fr: {
    ...
    wifiPasswordReenter: 'Merci de ressaisir le mot de passe (omis de l\'historique par sécurité)',
    ...
    templatesTitle: 'Modèles & Styles',
    presetMinimal: 'Minimaliste',
    ...
    bgColorLabel: 'Fond',
    transparentBgLabel: 'Fond Transparent',
    gradientLabel: 'Dégradé de Couleur',
    gradientTypeNone: 'Couleur Unie',
    gradientTypeLinear: 'Dégradé Linéaire',
    gradientTypeRadial: 'Dégradé Radial',
    gradientColorLabel: 'Seconde Couleur Dégradé',
    moduleStyleLabel: 'Style des Modules',
    styleSquare: 'Carré',
    styleRounded: 'Arrondi',
    styleDots: 'Points / Cercles',
    eyeStyleLabel: 'Style des Yeux (Coins)',
    eyeColorLabel: 'Couleur des Yeux',
    customEyeColorLabel: 'Couleur Yeux Personnalisée',
    ecLevelLabel: 'Correction d\'Erreur',
    ecL: 'Faible (7%)',
    ecM: 'Moyen (15%)',
    ecQ: 'Élevé (25%)',
    ecH: 'Maximal (30%)',
    marginLabel: 'Marge (Zone neutre)',
    sizeLabel: 'Taille',
    sizeSmall: 'Petite',
    sizeMedium: 'Moyenne',
    sizeLarge: 'Grande',
